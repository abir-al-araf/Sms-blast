...
logo = ("""
\033[1;31m┏━━┓━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┏━━⑊
\033[1;31m┃😈┃\033[47m\033[1;46m  𝗧𝗛𝗘 𝗖𝗬𝗕𝗘𝗥 @FF_MAHIR    ⑆➤    @FF_MAHIR  \033[40m\033[00m\x1b[1;91m┃😈┃
\033[1;31m┗━━┛━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┗━━┛""")
def lnx():print(52*f'{g}━')
def MAIN_x_FFKING0011():
    os.system("clear");LijA(logo2)
    print(f"\n{lgt}{y}{itl}{bgr}</> WARNING :{stp}{lgt}{y}{unl} This {r}\"FFMAHIR SMS SPAM\"{y} Developed For {stp}")
    print(f"{lgt}{y}{itl}{unl} - Only Educational Purpose & Cyber Awerness ! {stp}")
    print(f"{lgt}{y}{itl}{unl} - We {r}\"ISLAMIC CYBER FORCE 71\"{y} Are Not Promoted For {stp}")
